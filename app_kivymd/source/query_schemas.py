...
# Requests
SELECT_ALL_REQUESTS = "SELECT receivers, keys, creation_date FROM requests"
SELECT_ONE_REQUEST_BY_ID = "SELECT receivers, keys, creation_date FROM requests WHERE id = ?"
SELECT_ONE_REQUEST_BY_RECEIVERS = "SELECT keys, creation_date FROM requests WHERE `receivers` = ?"
